...
def main():
    ...
    LOG_FILE = f"results-v3/{args.exp_name}_log.txt"
    METRICS_FILE = f"results-v3/{args.exp_name}_metrics.csv"
    ...
    for epoch in range(epochs):
        ...
        save_confusion_matrix(
            ...
            f"results-v3/{args.exp_name}_confusion_val.csv"
        )

        save_report(
            val_result["report"],
            f"results-v3/{args.exp_name}_report_val.txt"
        )
        ...
        if tuned_f1 > best_f1:
            ...
            model_dir = f"models/clean-finetune/{args.exp_name}"
    ...
    save_confusion_matrix(
        ...
        f"results-v3/{args.exp_name}_confusion_test.csv"
    )

    save_report(
        test_result["report"],
        f"results-v3/{args.exp_name}_report_test.txt"
    )
